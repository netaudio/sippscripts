...
namespace YSMS
{
	...
	enum _CommandCode
	{
		YSMS_Login	                        = 1,  //客户端登录请求
		YSMS_Login_Resp                    = 2,  //客户端登录应答
		YSMS_Deliver                       = 3,  //上行短消息
//		YSMS_Deliver_Resp                  = 3,  //上行短消息应答
		YSMS_Submit                        = 4,  //下行短消息
//		YSMS_Submit_Resp                   = 4,  //下行短消息应答

		YSMS_Submit_Group                  = 5,  //群发下行短消息
		YSMS_Submit_Group_Resp             = 6,  //群发下行短消息应答

		YSMS_Active_Test                   = 7,  //连接激活测试
		YSMS_Active_Test_Resp              = 8,  //连接激活测试回应

		YSMS_GW_REPORT						= 9,  //网关状态报告
		YSMS_TERM_REPORT					= 10,  //终端状态报告
	};
