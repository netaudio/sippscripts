...
namespace SMGP
{
	...
	enum _CommandCode
	{
		SMGP_Login	                        = 0x00000001,  //客户端登录请求
		SMGP_Login_Resp                     = 0x80000001,  //客户端登录应答
		SMGP_Submit                         = 0x00000002,  //提交短消息
		SMGP_Submit_Resp                    = 0x80000002,  //提交短消息应答
		SMGP_Deliver                        = 0x00000003,  //下发短消息
		SMGP_Deliver_Resp                   = 0x80000003,  //下发短消息应答
		SMGP_Active_Test                    = 0x00000004,  //连接激活测试
		SMGP_Active_Test_Resp               = 0x80000004,  //连接激活测试回应
		SMGP_Exit	                        = 0x00000006,  //退出请求
		SMGP_Exit_Resp	                    = 0x80000006,  //退出应答
		SMGP_Query	                        = 0x00000007,  //SP统计查询请求
		SMGP_Query_Resp                     = 0x80000007,  //SP统计查询应答
	};
	...
	enum _Version  
	{
		Version_20                          = 0x20,        //SMGP 2.0
		Version_30                          = 0x30,        //SMGP 3.0
	};
